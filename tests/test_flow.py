...
def test_full_flow_create_interview_submit_answers_summarize():
    ...
    q1 = client.post(
        "/api/questions/", {"title": "Leadership clarity", "qtype": "Scale"}, format="json"
    )
    ...
    s1 = client.post(
        ...
        {"interview": interview_id, "question": q1_id, "answer_text": "4"},
        format="json",
    )
    s2 = client.post(
        "/api/submissions/create/",
        {"interview": interview_id, "question": q2_id, "answer_text": "Slack"},
        format="json",
    )
